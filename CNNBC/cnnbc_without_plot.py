...
for i in range(1):
 ...
 # trainb=[]
  ...
  history=model_CNNBC.fit(tx,ty,batch_size=16,epochs=500, verbose=2, validation_split=0.20,callbacks=[checkpoint, earlystop])   #original batch size=16
  model_CNNBC.save(path+"cnnbcmodel_4.h5", include_optimizer=True)
  #model_CNNBC.save(path+"my_cnntry2model_noOpt.h5")
  #model_CNNBC.save(path+"my_cnntry2model.keras")
...
def plot_history(history):
    ...
    #plt.show()
    plt.savefig(path+"historyplot2.png")
    plt.close("all")
