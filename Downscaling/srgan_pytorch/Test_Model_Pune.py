...
save_path="/home/users/bipink/DIAT/George_Jose/figures_april2025/Pune_figures/"
...
bhandar=[26.23327, 78.17376]
gird=[26.22011, 78.1762]
iiitm=[26.248468, 78.174592]
ghatigaon=[26.05213, 77.93503]
pichhore=[25.95734, 78.39294]



#bounds=[[25.8,27], [79.4,80.8]]            # Kanpur
#bounds=[[28.4, 29],[76.5, 77.5]]        # Delhi
bounds=[[17.5,20],[73,75.5]]                # Pune
#bounds=[[18.8,19.4],[72.6,73]]            # Mumbai
#bounds=[[25.7,26.4],[77.6,78.7]]
...
#ax[0].plot(pune_city[1],pune_city[0],'o',markersize=8, markerfacecolor='darkgreen',label='Pune city')
ax[0].plot(ghoda_ambegaon[1],ghoda_ambegaon[0],'ks',markersize=8, markeredgewidth=1.5,markerfacecolor='none',  label='Ghoda Ambegaon')
ax[0].plot(baramati[1],baramati[0],'o',markersize=10, markeredgewidth=2.0,markerfacecolor='none', markeredgecolor='darkgreen', label='Baramati')
ax[0].plot(indapur[1],indapur[0],'k+',markersize=10,label='Indapur')
ax[0].plot(pashan[1],pashan[0],'k1',markersize=10,label='Pashan')
...
#ax[1].plot(pune_city[1],pune_city[0],'o',markersize=8, markerfacecolor='darkgreen',label='Pune city')
ax[1].plot(ghoda_ambegaon[1],ghoda_ambegaon[0],'ks',markersize=8, markeredgewidth=1.5,markerfacecolor='none',  label='Ghoda Ambegaon')
ax[1].plot(baramati[1],baramati[0],'o',markersize=10, markeredgewidth=2.0,markerfacecolor='none', markeredgecolor='darkgreen', label='Baramati')
ax[1].plot(indapur[1],indapur[0],'k+',markersize=10,label='Indapur')
ax[1].plot(pashan[1],pashan[0],'k1',markersize=10,label='Pashan')
...
#plt.show()
plt.savefig(save_path+"pune_"+date_string.replace('-','_')+".png",dpi=400)
plt.close('all')
