...
sys.path.insert(0, "/home/users/bipink/DIAT/George_Jose/Downscaling/srgan_pytorch/")
...
save_path="/home/users/bipink/DIAT/George_Jose/figures_april2025/Delhi_figures/"
...
df = gpd.read_file("/home/users/bipink/DIAT/George_Jose/Data/Shape_files/DISTRICT_BOUNDARY.shp")
...
ax[0].plot(delhi_ridge[1],delhi_ridge[0],'o',markersize=8, markerfacecolor='darkgreen',label='Rashtrapati Bhav')
ax[0].plot(aya_nagar[1],aya_nagar[0],'o',markersize=10, markeredgewidth=2.0,markerfacecolor='none', markeredgecolor='darkgreen',  label='Aya Nagar')
ax[0].plot(najafgarh[1],najafgarh[0],'k+',markersize=10, label='Najafgarh')
#ax[0].plot(rashtrapati_bhav[1],rashtrapati_bhav[0],'k1',markersize=10,label='Rashtrapati Bhav')
ax[0].plot(lodi_road[1],lodi_road[0],'ks',markersize=8, markeredgewidth=1.5,markerfacecolor='none',label='Lodi road')
...
ax[1].plot(delhi_ridge[1],delhi_ridge[0],'o',markersize=8, markerfacecolor='darkgreen',label='Rashtrapati Bhav')
ax[1].plot(aya_nagar[1],aya_nagar[0],'o',markersize=10, markeredgewidth=2.0,markerfacecolor='none', markeredgecolor='darkgreen',  label='Aya Nagar')
ax[1].plot(najafgarh[1],najafgarh[0],'k+',markersize=10, label='Najafgarh')
#ax[1].plot(rashtrapati_bhav[1],rashtrapati_bhav[0],'k1',markersize=10,label='Rashtrapati Bhav')
ax[1].plot(lodi_road[1],lodi_road[0],'ks',markersize=8, markeredgewidth=1.5,markerfacecolor='none',label='Lodi road')
...
plt.show()
#plt.savefig(save_path+"delhi_grid_"+date_string.replace('-','_')+".png",dpi=400)
#plt.close('all')
