...
save_path="/home/users/bipink/DIAT/George_Jose/figures_april2025/Kanpur_figures/"
...
ax[0].plot(iit_kanpur[1],iit_kanpur[0],'o',markersize=8, markerfacecolor='darkgreen',label='IIT Kanpur')
ax[0].plot(kanpur[1],kanpur[0],'ks',markersize=8, markeredgewidth=1.5,markerfacecolor='none',  label='Kanpur')
ax[0].plot(ankinghat[1],ankinghat[0],'o',markersize=10, markeredgewidth=2.0,markerfacecolor='none', markeredgecolor='darkgreen', label='Ankinghat')
ax[0].plot(bilhaur[1],bilhaur[0],'k+',markersize=10,label='Bilhaur')
ax[0].plot(ghatampur[1],ghatampur[0],'k1',markersize=10,label='Ghatampur')
...
ax[1].plot(iit_kanpur[1],iit_kanpur[0],'o',markersize=8, markerfacecolor='darkgreen',label='IIT Kanpur')
ax[1].plot(kanpur[1],kanpur[0],'ks',markersize=8, markeredgewidth=1.5,markerfacecolor='none',  label='Kanpur')
ax[1].plot(ankinghat[1],ankinghat[0],'o',markersize=10, markeredgewidth=2.0,markerfacecolor='none', markeredgecolor='darkgreen', label='Ankinghat')
ax[1].plot(bilhaur[1],bilhaur[0],'k+',markersize=10,label='Bilhaur')
ax[1].plot(ghatampur[1],ghatampur[0],'k1',markersize=10,label='Ghatampur')
...
#plt.show()
plt.savefig(save_path+"kanpur_"+date_string.replace('-','_')+".png",dpi=400)
plt.close('all')
