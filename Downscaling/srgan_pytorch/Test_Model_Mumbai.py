...
save_path="/home/users/bipink/DIAT/George_Jose/figures_april2025/Mumbai_figures/"
...
ax[0].plot(podar_mc[1],podar_mc[0],'o',markersize=8, markerfacecolor='darkgreen',label='Podar MC')
ax[0].plot(colaba[1],colaba[0],'ks',markersize=8, markeredgewidth=1.5,markerfacecolor='none',  label='Colaba')
ax[0].plot(santacruz[1],santacruz[0],'o',markersize=10, markeredgewidth=2.0,markerfacecolor='none', markeredgecolor='darkgreen', label='Santacruz')
ax[0].plot(borivali[1],borivali[0],'k+',markersize=10,label='Borivali')
ax[0].plot(andheri[1],andheri[0],'k1',markersize=10,label='Andheri')
ax[0].legend(loc='upper left',fontsize=8)

ax[0].set_xlim(bounds[1])
ax[0].set_ylim(bounds[0])

ax[0].xaxis.set_major_locator(MultipleLocator(0.25))            # enable grid
...
ax[1].plot(podar_mc[1],podar_mc[0],'o',markersize=8, markerfacecolor='darkgreen',label='Podar MC')
ax[1].plot(colaba[1],colaba[0],'ks',markersize=8, markeredgewidth=1.5,markerfacecolor='none',  label='Colaba')
ax[1].plot(santacruz[1],santacruz[0],'o',markersize=10, markeredgewidth=2.0,markerfacecolor='none', markeredgecolor='darkgreen', label='Santacruz')
ax[1].plot(borivali[1],borivali[0],'k+',markersize=10,label='Borivali')
ax[1].plot(andheri[1],andheri[0],'k1',markersize=10,label='Andheri')
...
#plt.show()
plt.savefig(save_path+"mumbai_"+date_string.replace('-','_')+".png",dpi=400)
plt.close('all')
