...
optimizer = optim.LBFGS(model.parameters(), history_size=10, max_iter=4)
...
params={'lr':CONFIG["LEARNING_RATE"],'batch_size':CONFIG["BATCH_SIZE"], 'split':split_ratio,
        'remark':'New model, IMDAA 3h as ground truth, Min-max Norm, lbfgs optimizer'}
