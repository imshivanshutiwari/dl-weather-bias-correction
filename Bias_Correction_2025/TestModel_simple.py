...
from model_4 import ResCNNv4  # Using original model
...
# Create model instance (untrained for testing)
print("Creating model...")
model = ResCNNv4(in_channels=10, out_channels=1, n_residual_blocks=8)
...
if output_std < 0.001:
    ...
    print("✅ Output shows variation (no blue map issue)")
