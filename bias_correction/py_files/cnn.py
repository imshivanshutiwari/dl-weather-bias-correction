...
train_year=np.load('/home/hpcs_rnd/Yatendra_IITKgp/data/data/YearIndex500Train.npy')
test_year=np.load('/home/hpcs_rnd/Yatendra_IITKgp/data/data/YearIndex500Test.npy')

data=np.load("/home/hpcs_rnd/Yatendra_IITKgp/data/data/inputdata100.npy") # Load the input samples for the model(biased data samples) 
label=np.load("/home/hpcs_rnd/Yatendra_IITKgp/data/data/label100.npy") # Load the labels(observation samples)
#biasdata=np.load("./Data/biasdata100.npy") 


def preprocess_data(data, label):
    # Crop or resize input data to match expected shape
    data = data[:, :10, :32, :32, np.newaxis]  # Crop or resize to match (None, 10, 32, 32, 1)
...
# Preprocess data
data, label = preprocess_data(data, label)# Crop or resize to match (None, 32, 32)
...
for i in range(1):
 ...
 # trainb=[]
  ...
  path= "/home/hpcs_rnd/Yatendra_IITKgp/data/"
